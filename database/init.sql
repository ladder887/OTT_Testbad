...
VALUES
('admin@ott.com', 'admin', crypt('admin123!', gen_salt('bf')), 'Admin User', 'premium'),
('user1@test.com', 'testuser1', crypt('testpass123', gen_salt('bf')), 'Normal User 1', 'standard'),
('user2@test.com', 'testuser2', crypt('testpass123', gen_salt('bf')), 'Normal User 2', 'standard'),
('user3@test.com', 'testuser3', crypt('testpass123', gen_salt('bf')), 'Normal User 3', 'standard'),
('user4@test.com', 'testuser4', crypt('testpass123', gen_salt('bf')), 'Normal User 4', 'standard'),
('user5@test.com', 'testuser5', crypt('testpass123', gen_salt('bf')), 'Normal User 5', 'standard'),
('user6@test.com', 'testuser6', crypt('testpass123', gen_salt('bf')), 'Normal User 6', 'standard'),
('user7@test.com', 'testuser7', crypt('testpass123', gen_salt('bf')), 'Normal User 7', 'standard'),
('user8@test.com', 'testuser8', crypt('testpass123', gen_salt('bf')), 'Normal User 8', 'standard'),
('user9@test.com', 'testuser9', crypt('testpass123', gen_salt('bf')), 'Normal User 9', 'standard'),
('user10@test.com', 'testuser10', crypt('testpass123', gen_salt('bf')), 'Normal User 10', 'standard')
