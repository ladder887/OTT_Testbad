...
// 대용량 업로드는 엣지 프록시를 우회해 API 직통 경로를 사용할 수 있다.
const API_UPLOAD_URL = (import.meta.env.VITE_API_UPLOAD_URL || API_URL).replace(/\/+$/, '');
...
export const contentAPI = {
  ...
  uploadManaged: (formData, options = {}) =>
    api.post(`${API_UPLOAD_URL}/api/content/admin/upload`, formData, {
      headers: {
